        ...
        {data.cvUrl && (
          <div className="flex justify-center">
            <Link
              ...
              className="inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-md text-white bg-blue-900/90 hover:bg-gray-900 transition-colors duration-200"
            >
              View Resume (PDF)
            </Link>
          </div>
